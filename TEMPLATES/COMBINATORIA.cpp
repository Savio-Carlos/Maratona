...
// This is needed for calculating the modular inverse in the combinations_mod function.
...
// This works only when MOD is a prime number.
// The modular inverse of a is a^(MOD-2) % MOD.
